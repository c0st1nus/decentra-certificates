...
- нет реальной серверной генерации PDF
...
- [ ] Реализовать поиск участника по e-mail
- [ ] Реализовать генерацию PDF на сервере
- [ ] Реализовать скачивание готового сертификата
- [ ] Подключить публичную форму frontend к API
- [ ] Обработать все пользовательские статусы
