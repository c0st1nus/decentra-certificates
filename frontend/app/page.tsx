          ...
          <div className="mx-auto w-full max-w-2xl space-y-8 text-center">
            <div className="space-y-5">
              ...
              <p className="mx-auto max-w-xl text-sm leading-6 text-white/68 sm:text-base">
                Введите e-mail, указанный при регистрации, и мы проверим участие на сервере. Если
                адрес совпадет, вы сразу получите PDF-сертификат на скачивание.
              </p>
            </div>
            ...
            <p className="text-xs leading-5 text-white/42">
              Сертификат выдается только после серверной проверки базы участников.
            </p>
          </div>
        </section>
      </div>
